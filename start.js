...
Don't forget to follow to the Channel developer -> https://whatsapp.com/channel/0029Vay6o2QKLaHpUQGAOA2Z so you can get the latest updates about this script :)`.toString()}`})
const formatp = (bytes) => {
...
try {
const qtext = {key: {remoteJid: "status@broadcast", participant: "0@s.whatsapp.net"}, message: { "extendedTextMessage": {"text": "[ Hai, my name hira ]"}}}
